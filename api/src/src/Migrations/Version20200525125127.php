...
final class Version20200525125127 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE randa (id INT AUTO_INCREMENT NOT NULL, region_id INT NOT NULL, year INT NOT NULL, current_timeslot VARCHAR(255) DEFAULT \'T0\' NOT NULL, INDEX IDX_BFC7CD9398260155 (region_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE chapters (id INT AUTO_INCREMENT NOT NULL, region_id INT NOT NULL, director_id INT NOT NULL, name VARCHAR(32) NOT NULL, current_state VARCHAR(10) DEFAULT \'PROJECT\' NOT NULL, prev_launch_coregroup_date DATE NOT NULL, actual_launch_coregroup_date DATE NOT NULL, prev_launch_chatper_date DATE NOT NULL, actual_launch_chatper_date DATE NOT NULL, susp_date DATE NOT NULL, prev_resume_date DATE NOT NULL, actual_resume_date DATE NOT NULL, closure_date DATE NOT NULL, INDEX IDX_C721437198260155 (region_id), INDEX IDX_C7214371899FB366 (director_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE directors (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, region_id INT DEFAULT NULL, supervisor_id INT DEFAULT NULL, role VARCHAR(10) NOT NULL, pay_type VARCHAR(8) NOT NULL, launch_percentage DOUBLE PRECISION DEFAULT \'0\' NOT NULL, green_light_percentage DOUBLE PRECISION DEFAULT \'0\' NOT NULL, yellow_light_percentage DOUBLE PRECISION DEFAULT \'0\' NOT NULL, red_light_percentage DOUBLE PRECISION DEFAULT \'0\' NOT NULL, grey_light_percentage DOUBLE PRECISION DEFAULT \'0\' NOT NULL, fixed_percentage DOUBLE PRECISION DEFAULT \'0\' NOT NULL, INDEX IDX_A6ADADC4A76ED395 (user_id), INDEX IDX_A6ADADC498260155 (region_id), INDEX IDX_A6ADADC419E9AC5F (supervisor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE randa ADD CONSTRAINT FK_BFC7CD9398260155 FOREIGN KEY (region_id) REFERENCES regions (id)');
        ...
        $this->addSql('ALTER TABLE chapters ADD CONSTRAINT FK_C721437198260155 FOREIGN KEY (region_id) REFERENCES regions (id)');
        ...
        $this->addSql('ALTER TABLE directors ADD CONSTRAINT FK_A6ADADC498260155 FOREIGN KEY (region_id) REFERENCES regions (id)');
