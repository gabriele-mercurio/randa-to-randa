...
final class Version20200527090043 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE randa CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', CHANGE region_id region_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE chapters CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', CHANGE region_id region_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', CHANGE director_id director_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE directors CHANGE id id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', CHANGE region_id region_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', CHANGE supervisor_id supervisor_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE directors DROP FOREIGN KEY FK_A6ADADC498260155');
        $this->addSql('ALTER TABLE directors DROP FOREIGN KEY FK_A6ADADC419E9AC5F');
        $this->addSql('ALTER TABLE chapters CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE region_id region_id INT NOT NULL, CHANGE director_id director_id INT NOT NULL');
        $this->addSql('ALTER TABLE directors CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE region_id region_id INT DEFAULT NULL, CHANGE supervisor_id supervisor_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE randa CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE region_id region_id INT NOT NULL');
