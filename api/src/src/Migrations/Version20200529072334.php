...
final class Version20200529072334 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chapters CHANGE actual_launch_coregroup_date actual_launch_coregroup_date DATE DEFAULT NULL, CHANGE actual_launch_Chapter_date actual_launch_Chapter_date DATE DEFAULT NULL, CHANGE susp_date susp_date DATE DEFAULT NULL, CHANGE prev_resume_date prev_resume_date DATE DEFAULT NULL, CHANGE actual_resume_date actual_resume_date DATE DEFAULT NULL, CHANGE closure_date closure_date DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chapters CHANGE actual_launch_coregroup_date actual_launch_coregroup_date DATE NOT NULL, CHANGE actual_launch_Chapter_date actual_launch_Chapter_date DATE NOT NULL, CHANGE susp_date susp_date DATE NOT NULL, CHANGE prev_resume_date prev_resume_date DATE NOT NULL, CHANGE actual_resume_date actual_resume_date DATE NOT NULL, CHANGE closure_date closure_date DATE NOT NULL');
