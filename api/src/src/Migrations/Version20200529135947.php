 ...
 */
final class Version20200529135947 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE strategies_per_randa ADD CONSTRAINT FK_D4336D0FE2403D36 FOREIGN KEY (randa_id) REFERENCES randa (id)');
    }
